...
public class WebServiceUtil {
    ...
    private static final String URL_DEPOSITO_FINDALL = getUrl() + "deposito/findAllByInvestidor";
    ...
    private static final String URL_COMPRA_FINDALL = getUrl() + "compra/findAllByInvestidor";
    ...
    private static final String URL_DESPESA_FINDALL = getUrl() + "despesa/findAllByInvestidor";
    ...
    private static final String URL_MOEDA_FINDALL = getUrl() + "moeda/findAllByInvestidor";
    ...
    private static final String URL_SAQUE_FINDALL = getUrl() + "saque/findAllByInvestidor";
    ...
    private static final String URL_VENDA_FINDALL = getUrl() + "venda/findAllByInvestidor";

   private static final String URL_MOVIMENTACOES_SAVE = getUrl() + "movimentacao/save";
   private static final String URL_MOVIMENTACOES_DELETE = getUrl() + "movimentacao/delete";
    private static final String URL_MOVIMENTACOES_UPDATE = getUrl() + "movimentacao/update";
    private static final String URL_MOVIMENTACOES_FINDALL = getUrl() + "movimentacao/findAllByInvestidor";
    ...
    public static String getUrlMovimentacoesDelete() {
        return URL_MOVIMENTACOES_DELETE;
    }
}